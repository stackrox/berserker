...
mod tests {
    use super::*;
    // Following tests are not verifying the workload output, they only make
    // sure the executor does not crash. No runs with distibutions yet,
    // because those require an external terminator to stop.
