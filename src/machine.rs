...
use aya::{Btf, Ebpf, Endianness, include_bytes_aligned, programs::FEntry};
...
/// Spin up fentry/fexit programs to profile target bpf progs
/// TODO: Fix BTF discovery for the target bpf prog
